...
#define _textcolor      textcolor
#define _textbackground textbackground
...
//#define _insline        insline (not implemented)       
//#define _delline        delline (not implemented)       
//#define _cgets          cgets   (not implemented)       
//#define _getpass        getpass (not implemented)        
//#define _gettext        gettext (not implemented)
#define _cprintf        cprintf
#define _cscanf         cscanf
#define _cputs          cputs
#define _getche         getche
